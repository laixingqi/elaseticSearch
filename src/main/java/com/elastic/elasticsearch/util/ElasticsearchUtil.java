package com.elastic.elasticsearch.util;
...
public class ElasticsearchUtil {
	 ...
	 * @return
	 */
	public void CreateIndexAndMapping(String index, String type) throws Exception {

		CreateIndexRequestBuilder cib = client.admin().indices().prepareCreate(index);// 索引
		XContentBuilder mapping = XContentFactory.jsonBuilder().startObject().startObject("properties") // 设置定义字段
				.startObject("author").field("type", "string") // 设置数据类型
		...
		cib.addMapping(type, mapping); // 类型
